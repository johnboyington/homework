...
class Probe(object):
    ...
    def individuals(self, ran):
        ...
        [(2,4),
         (2.2,0), (3.0,0), 
         (2.5,0), (3.0,0), (3.0,0), 
         (3.0,0), (3.0,0), (4.0,0), (3.0,0), 
         (3.0,0), (3.0,0), (4.0,0), (3.0,0), (3.0,0), 
         (3.0,0), (3.0,0), (3.0,0), (2.0,2), (2.0,2), (3.0,0), 
         (3.0,0), (3.0,0), (3.0,0), (2.0,2), (2.0,2), (3.0,0), (4.0,0), 
         (2.5,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), (4.0,0), (4.2,0), (4.0,0), 
         (2.2,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), 
         (2.0,0), (2.2,0), (2.5,0), (3.0,0), (3.0,0), (3.0,0), (3.0,0), (2.5,0), (2.2,0), (2,4)]
    ...
    def plot_individual(self, ind):
        ...
        ax.plot([0, 37], [1.13, 1.13], 'k')
        ax.plot([0, 37], [1.00, 1.00], 'k')
        ax.plot(ind.k_inf)
