...
/*-----------------------------------------------
              @(target):= _interpolate.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__interpolate

#else
#  define SWIG_init    init_interpolate

#endif
#define SWIG_name    "_interpolate"
...
SWIGINTERN PyObject *_wrap_interpolate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "interpolate" "', argument " "6"" of type '" "int""'");
  } 
  arg6 = static_cast< int >(val6);
  ecode7 = SWIG_AsVal_int(obj4, &val7);
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "interpolate" "', argument " "7"" of type '" "int""'");
  } 
  arg7 = static_cast< int >(val7);
  result = (double)interpolate(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
